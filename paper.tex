...
reduction rule, exploiting the sparseness of the bit vectors. In ZBDDs, nodes can be
eliminated whenever setting the corresponding variable to 1 yields 0 as result,

...
Hence, the following section cover important aspects to keep in mind when
implementing an OBDD framework efficiently, i.e. data structures, how to deal with
the variable ordering problem and \textit{garbage collection}. \tbr

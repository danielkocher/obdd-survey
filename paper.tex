...
\begin{figure}[ht]
    ...
    \subfigure[]{
        ...
        \label{fig:redundant-nonterminals-before}
    }
    \hskip1cm
    \subfigure[]{
        \includestandalone[height = 3cm]{figs/redundant-nonterminals-after}
        \label{fig:redundant-nonterminals-after}
    }
    \label{fig:redundant-nonterminals}
    \caption{Eliminating redundant nonterminal nodes.}
\end{figure}

Figure~\ref{fig:obdd} shows the result of applying the first two transformation
rules to the BDD shown in Figure~\ref{fig:bdd}. The third rule is shown
in Figure~\ref{fig:redundant-nonterminals}.
Figure~\ref{fig:redundant-nonterminals-before} shows a BDD with redundant
nonterminal nodes (both \textbf{B}'s, in essence) and
Figure~\ref{fig:redundant-nonterminals-after} shows the equivalent OBDD without

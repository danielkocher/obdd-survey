...
variable assignment. Akers~\cite{AKERS78} already provided some techniques to
simplify the BDD representation such as combining equivalent nodes.

\begin{figure}[ht]
    \centering
    \subfigure[BDD \newline $f=(A \land B) \lor (B \land C)$.]{

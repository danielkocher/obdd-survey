...
ordering of the so-called \textit{decision variables} represented by the vertices
of the BDD. Furthermore, Bryant\cite{BRYANT86} was able to derive a reduced
representation of BDDs providing the DAG in a canonical form. The following two

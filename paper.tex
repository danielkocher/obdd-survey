...
the result of $f$ is fixed, an edge points to one of the constants 0 or 1.
To evaluate $f$ for a given variable assignment, one just follows the path for
the respective variable values. As soon as the path ends up in a constant, i.e. 
0 or 1, this constant value is the result of the variable assignment.
\tbr

...
Before discussing the symbolic model checking algorithms \texttt{BDD}$_f$ and
\texttt{BDD}$_R$, the used $\mu$-Calculus has to be described. For a given finite
...
fact generalizes the introduced algorithms to any \textit{finite} domain. \tbr

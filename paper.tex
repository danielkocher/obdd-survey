...
\textit{ITE} operator, how to possibly approach the variable ordering problem
and \textit{garbage collection}.
\tbr
...
existing entries. \textit{Hash-based caches} issue a cache miss if a looked up
element is not found. \tbr
